...
!(function(t, e) {
    ...
    function ft(t) {
        ...
        return (
            ...
            Math.abs(e.height - s) <= 1 && (s = e.height), { x: t.offsetLeft, y: t.offsetTop, width: i, height: s }
        );
    }
                ...
                (function(t) {
                    ...
                    return (
                        ...
                        ((n = s.width),
                            ...
                            ((r = s.offsetLeft), (a = s.offsetTop))), { width: n, height: o, x: r + Bt(t), y: a }
                    );
                })(t)
            ) :
            at(e) ?
            ...
            Ut(
                (function(t) {
                    ...
                    return (
                        ...
                        (a += wt(i.clientWidth, n ? n.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
                    );
                })(mt(t))
            );
    }
                    ...
                    r = it.reduce(function(t, i) {
                        return (
                            (t[i] = (function(t, e, i) {
                                ...
                                return (
                                    (r = r || 0),
                                    (a = (a || 0) * n), [J, Z].indexOf(s) >= 0 ? { x: a, y: r } : { x: r, y: a }
                                );
                            })(i, e.rects, o)),
                            t
                        );
    ...
    class qe extends j {
        static get DATA_KEY() {
            return "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/bs.tab";
        }
        show() {
            if (
                (this._element.parentNode &&
            ...
            const n = t ?
                N.trigger(
                    t,
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/hide.bs.tab", { relatedTarget: this._element }
                ) :
                null;
            if (
                N.trigger(
                    this._element,
                    "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/show.bs.tab", { relatedTarget: t }
                ).defaultPrevented ||
            ...
            const o = () => {
                N.trigger(
                        t,
                        "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/hidden.bs.tab", { relatedTarget: this._element }
                    ),
                    N.trigger(
                        this._element,
                        "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/shown.bs.tab", { relatedTarget: t }
                    );
            };
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                const e =
                    b.get(
                        this,
                        "https://themesbrand.com/foxia/layouts/blue/assets/libs/bootstrap/js/bs.tab"
                    ) || new qe(this);
                if ("string" == typeof t) {
                    if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
                    e[t]();
