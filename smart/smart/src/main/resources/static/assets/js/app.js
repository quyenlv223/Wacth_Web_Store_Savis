!(function(e) {
        ...
        1 == e("#light-mode-switch").prop("checked") && "light-mode-switch" === t ?
            (e("html").removeAttr("dir"),
                ...
                e("#bootstrap-style").attr(
                    "href",
                    "assets/css/bootstrap.min.css" /*tpa=https://themesbrand.com/foxia/layouts/blue/assets/js/assets/css/bootstrap.min.css*/
                ),
                e("#app-style").attr(
                    "href",
                    "assets/css/app.min.css" /*tpa=https://themesbrand.com/foxia/layouts/blue/assets/js/assets/css/app.min.css*/
                ),
            ...
            (e("html").removeAttr("dir"),
                ...
                e("#bootstrap-style").attr(
                    "href",
                    "assets/css/bootstrap-dark.min.css" /*tpa=https://themesbrand.com/foxia/layouts/blue/assets/js/assets/css/bootstrap-dark.min.css*/
                ),
                e("#app-style").attr(
                    "href",
                    "assets/css/app-dark.min.css" /*tpa=https://themesbrand.com/foxia/layouts/blue/assets/js/assets/css/app-dark.min.css*/
                ),
    ...
    e("#side-menu").metisMenu(),
        ...
        e(".navbar-nav>li").slice(-1).addClass("last-elements"),
        e(document).ready(function() {
            ...
            0 < e("#sidebar-menu").length &&
                ...
                ((t -= 300),
                    e(".vertical-menu .simplebar-content-wrapper").animate({ scrollTop: t },
                        "slow"
                    ));
        }),
